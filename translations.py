...
Que souhaites-tu faire ?",
        ...
        "send_source": (
            "🔗 Envoie un lien YouTube ou TikTok, ou transfère-moi un audio "
            "ou une vidéo Telegram.

Tu peux annuler avec /cancel."
        ),
        "invalid_link": (
            "❌ Ce lien n'est pas reconnu. Envoie un lien YouTube ou TikTok valide."
        ),
...
What would you like to do?",
        ...
        "send_source": (
            "🔗 Send a YouTube or TikTok link, or forward a Telegram audio or video."
            "

You can cancel with /cancel."
        ),
        "invalid_link": (
            "❌ This link is not supported. Send a valid YouTube or TikTok link."
        ),
